...
////    @EnvironmentObject var user: UseruserAPIViewModel
...
//
//            self.userAPIViewModel.user.googleAPIData = User.GoogleAPIData(googleAPIData)
//            print("log: \(self.userAPIViewModel.user)")
//
//            
////            print("SETSTEST")
...
//
//
//            self.userAPIViewModel.request("join", "GOOGLE", self.userAPIViewModel.user) { (result, data) in
//                DispatchQueue.main.async { [weak self] in
//                    print(self?.message)
//                    //                self.message = data as! String
//
//                    print("ASDFDASFASDFADSF")
//                    self?.userAPIViewModel.user.userAPIData = User.JoinAPIData(data as! UserAPIViewModel.Responses.JoinAPIData)
//                    print(self?.userAPIViewModel.user)
//                    if result {
//                        self?.message = "로그인 성공"
